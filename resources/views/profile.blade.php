          ...
          <div class="row gutters-sm">
            <div class="col-md-2 mb-3">
              ...
              <div class=" d-grid gap-2">
                <br>
                <button type="button" class="btn btn-secondary">Ubah Foto Profile</button>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Level Karyawan</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                        {{ $profile->level }}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Posisi Karyawan</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                        {{ $profile->posisi }}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Kelas Karyawan</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                        {{ $profile->kelas }}
                    </div>
