                    ...
                    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                            <ul class="nav flex-column mb-auto">
                                ...
                                <li class="nav-item">
                                <a class="nav-link d-flex text-dark align-items-center gap-2" href="{{ url('/user/profile') }}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex text-dark align-items-center gap-2" href="/admin/karyawan">
                                ...
                                @endif
                                <li class="nav-item">
                                    <a class="nav-link d-flex text-dark align-items-center gap-2" href="/user/create">
